...
const Banner = styled(Box)`
    background-image: url(https://images5.alphacoders.com/133/thumbbig-1338166.webp);
    width: 100%;
    height: 50vh;
...
const About = () => {
    ...
    return (
        <Box>
            <Banner/>
            <Wrapper>
                <Typography variant="h3">About Devloper</Typography>
                <Text variant="h5">I'm a Software Engineer. 
                    ...
                    <Box component="span" style={{ marginLeft: 5 }}>
                        <Link href="https://github.com/abhayyadav9" color="inherit" target="_blank"><GitHub /></Link>
                    </Box>
                </Text>
                <Text variant="h5">
